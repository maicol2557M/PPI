    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
                <h1 class="all-tittles">Regulacion fiscal<small></small></h1>
            </div>
        </div>
            ...
            <nav class="navbar bg-body-tertiary">
                <div class="container-fluid">
                    <div>
                        ...
                        <button class="btn-small" style="margin-left: 8px;" onclick="window.open('/reports/export-pdf?type=regulacion_fiscal', '_blank')">
                            <i class="zmdi zmdi-file-text"></i> PDF
                        </button>
                        <button class="btn-small" style="margin-left: 8px;" onclick="window.open('/reports/export-csv?type=regulacion_fiscal', '_blank')">
