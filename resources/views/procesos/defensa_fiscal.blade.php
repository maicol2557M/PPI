...
<head>
    <title>Defensa fiscal y representacion juridica</title>
    <meta charset="UTF-8">
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
                <h1 class="all-tittles">Defensa fiscal y representacion juridica<small></small></h1>
            </div>
        </div>
        <div class="container-fluid" style="margin: 50px 0;">
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-3">
                    <img src="{{asset('assets/img/section.png')}}" alt="user" class="img-responsive center-box"
                ...
                <nav class="navbar bg-body-tertiary">
                    <div class="container-fluid">
                        <div>
                            ...
                            <button class="btn-small" style="margin-left: 8px;" onclick="window.open('/reports/export-pdf?type=defensa_fiscal', '_blank')">
                                <i class="zmdi zmdi-file-text"></i> PDF
                            </button>
                            <button class="btn-small" style="margin-left: 8px;" onclick="window.open('/reports/export-csv?type=defensa_fiscal', '_blank')">
