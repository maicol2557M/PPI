        ...
        <div class="container-fluid" style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección donde se encuentra el listado de los clientes del proceso planeación Fiscal
                    Estratégica. Puedes actualizar
                    o eliminar los datos de los clientes siempre y cuando no tenga procesos asociados.
                </div>
            </div>
        </div>
        <hr>
            ...
            <nav class="navbar bg-body-tertiary">
                <div class="container-fluid">
                    <div>
                        ...
                        <button class="btn-small" style="margin-left: 8px;" onclick="window.open('/reports/export-pdf?type=planeacion_fiscal', '_blank')">
                            <i class="zmdi zmdi-file-text"></i> PDF
                        </button>
                        <button class="btn-small" style="margin-left: 8px;" onclick="window.open('/reports/export-csv?type=planeacion_fiscal', '_blank')">
