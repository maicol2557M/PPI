...
<head>
    <title>Consultoría Jurídica Empresarial</title>
    <meta charset="UTF-8">
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
                <h1 class="all-tittles">Consultoría Jurídica Empresarial<small></small></h1>
            </div>
        </div>
        <div class="container-fluid" style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead" style="text-align: center;">
                    Bienvenido a la sección donde se encuentra el listado de los clientes. Puedes actualizar o
            ...
            <nav class="navbar bg-body-tertiary">
                <div class="container-fluid">
                    <div>
                        ...
                        <button class="btn-small" style="margin-left: 8px;" onclick="window.open('/reports/export-pdf?type=consulta_juridica_empresarial', '_blank')">
                            <i class="zmdi zmdi-file-text"></i> PDF
                        </button>
                        <button class="btn-small" style="margin-left: 8px;" onclick="window.open('/reports/export-csv?type=consulta_juridica_empresarial', '_blank')">
