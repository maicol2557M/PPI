    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
                <h1 class="all-tittles">Usuarios<small></small></h1>
            </div>
        </div>
            ...
            <nav class="navbar bg-body-tertiary">
                <div class="container-fluid">
                    <div>
                        ...
                        <button class="btn-small" style="margin-left: 8px;" onclick="window.location.href='/reports/export-pdf?type=usuarios'">
                            <i class="zmdi zmdi-file-text"></i> PDF
                        </button>
                        <button class="btn-small" style="margin-left: 8px;" onclick="window.location.href='/reports/export-csv?type=usuarios'">
